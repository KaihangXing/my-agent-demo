/* $ANTLR 2.7.2: "java_expression.g" -> "JavaExpressionLexer.cc"$ */
...
#line 16 "JavaExpressionLexer.cc"
	...
	for (;;) {
		...
		{   // TRY for lexical and char stream error handling
			...
			case static_cast<unsigned char>('9'):
			{
				...
				if (ActiveException()) goto _catch32;
			...
			// dbg: genBlockFinish - a
				...
				else {SetException(new ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn())); goto _catch32;}
			}
			}
			if ( !_returnToken )
...
void JavaExpressionLexer::mNumericLiteral(bool _createToken) {
	...
	if (((LA(1) == static_cast<unsigned char>('0')) && (LA(2) == static_cast<unsigned char>('x')))) {
		...
		{ //xxx_catch33
			...
			match("0x");
			if (ActiveException()) goto _catch33;//gen(StringLiteralElement atom)
			}
		}
		_catch33:
		{
...
#line 92 "java_expression.g"
			_ttype = HEX_NUMERIC_LITERAL;
#line 637 "JavaExpressionLexer.cc"
		}
	}
	else {
		//DBG gen=>(SynPredBlock)
		...
		if ( synPredMatched11 ) {
			...
			//DBG genAction(ActionElement action
			if ( inputState->guessing==0 ) {
#line 95 "java_expression.g"
				_ttype = OCT_NUMERIC_LITERAL;
#line 720 "JavaExpressionLexer.cc"
			}
		}
		else {
			//DBG gen=>(SynPredBlock)
			...
			if ( synPredMatched18 ) {
				...
				//DBG genAction(ActionElement action
				if ( inputState->guessing==0 ) {
#line 98 "java_expression.g"
					_ttype = FP_NUMERIC_LITERAL;
#line 851 "JavaExpressionLexer.cc"
				}
			}
			else {
				//DBG gen=>(SynPredBlock)
					...
					{ //xxx_catch36
						...
						for (;;) {
							...
							if (((LA(1) >= static_cast<unsigned char>('0') && LA(1) <= static_cast<unsigned char>('9')))) {
								...
								if ( _cnt26>=1 ) { goto _loop26; } else {SetException(new ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn())); goto _catch36;}
							}
						...
						default:
						{
							SetException(new ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn())); goto _catch36;
						}
						}
						}
						}
				...
				if ( synPredMatched28 ) {
					...
					//DBG genAction(ActionElement action
					if ( inputState->guessing==0 ) {
#line 101 "java_expression.g"
						_ttype = FP_NUMERIC_LITERAL;
#line 1002 "JavaExpressionLexer.cc"
					}
				}
					...
					//DBG genAction(ActionElement action
					if ( inputState->guessing==0 ) {
#line 104 "java_expression.g"
						_ttype = DEC_NUMERIC_LITERAL;
#line 1053 "JavaExpressionLexer.cc"
					}
				}
				else if ((LA(1) == static_cast<unsigned char>('.')) && (true)) {
					//DBG genChar(CharLiteralElement)
					...
					//DBG genAction(ActionElement action
					if ( inputState->guessing==0 ) {
#line 106 "java_expression.g"
						_ttype = DOT;
#line 1064 "JavaExpressionLexer.cc"
					}
				}
	else {
		SetException(new ANTLR_USE_NAMESPACE(antlr)NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn())); return ;
	...
	if ( synPredMatched49 ) {
		...
		if (((LA(1) == static_cast<unsigned char>('\\')) && ((LA(2) >= static_cast<unsigned char>('0') && LA(2) <= static_cast<unsigned char>('7'))) && ((LA(3) >= static_cast<unsigned char>('0') && LA(3) <= static_cast<unsigned char>('7'))))) {
			...
			{ //xxx_catch38
				...
				//DBG genChar(CharLiteralElement)
				match(static_cast<unsigned char>('\\'));
				if (ActiveException()) goto _catch38;//gen(CharLiteralElement atom)
				//DBG RuleRefElement( mOctDigit)
				mOctDigit(false);
				if (ActiveException()) goto _catch38;
				//DBG RuleRefElement( mOctDigit)
				mOctDigit(false);
				if (ActiveException()) goto _catch38;
				}
...
void JavaExpressionLexer::mWS(bool _createToken) {
	...
	//DBG genAction(ActionElement action
	if ( inputState->guessing==0 ) {
#line 197 "java_expression.g"
		_ttype = antlr::Token::SKIP;
#line 2337 "JavaExpressionLexer.cc"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void JavaExpressionLexer::mCOMMENT(bool _createToken) {
	...
	//DBG genAction(ActionElement action
	if ( inputState->guessing==0 ) {
#line 202 "java_expression.g"
		_ttype = antlr::Token::SKIP;
#line 2387 "JavaExpressionLexer.cc"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
void JavaExpressionLexer::mLINE_COMMENT(bool _createToken) {
	...
	//DBG genAction(ActionElement action
	if ( inputState->guessing==0 ) {
#line 207 "java_expression.g"
		_ttype = antlr::Token::SKIP;
#line 2433 "JavaExpressionLexer.cc"
	}
	if ( _createToken && _token==ANTLR_USE_NAMESPACE(antlr)nullToken && _ttype!=ANTLR_USE_NAMESPACE(antlr)Token::SKIP ) {
	   _token = makeToken(_ttype);
	   _token->setText(text.substr(_begin, text.length()-_begin));
...
// CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE CMP_GE NOTEQUAL AND CARET 
// MOD SHIFT_LEFT SHIFT_RIGHT_S SHIFT_RIGHT_U WS 
...
// ASSIGN CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE CMP_GE NOTEQUAL 
// AND 
...
// CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE CMP_GE NOTEQUAL AND SHIFT_RIGHT_S 
// WS 
...
// NULL_TREE_LOOKAHEAD STATEMENT BINARY_EXPRESSION INSTANCEOF_BINARY_EXPRESSION 
// UNARY_EXPRESSION PARENTHESES_EXPRESSION TYPE_CAST TYPE_NAME PRIMARY_SELECTOR 
// DOT_SELECTOR METHOD_CALL EXPRESSION_LIST "null" "true" "false" "instanceof" 
// DOT HEX_NUMERIC_LITERAL OCT_NUMERIC_LITERAL FP_NUMERIC_LITERAL DEC_NUMERIC_LITERAL 
...
// UnicodeEscape ZeroToThree Identifier LPAREN LBRACE RBRACE LBRACK RBRACK 
// SEMI COMMA ASSIGN CMP_GT CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE 
// CMP_GE NOTEQUAL AND OR ADD SUB MUL DIV BITAND BITOR CARET MOD SHIFT_LEFT 
...
// DOT HEX_NUMERIC_LITERAL OCT_NUMERIC_LITERAL FP_NUMERIC_LITERAL DEC_NUMERIC_LITERAL 
// HexDigit DecDigit OctDigit NumericLiteral CharacterLiteral SingleCharacter 
// StringLiteral StringCharacters StringCharacter EscapeSequence UnicodeEscape 
// ZeroToThree Identifier LPAREN RPAREN LBRACE RBRACE LBRACK RBRACK SEMI 
// COMMA ASSIGN CMP_GT CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE CMP_GE 
// NOTEQUAL AND OR ADD SUB MUL DIV BITAND BITOR CARET MOD SHIFT_LEFT SHIFT_RIGHT_S 
// SHIFT_RIGHT_U WS COMMENT LINE_COMMENT 
...
// HexDigit DecDigit OctDigit NumericLiteral CharacterLiteral SingleCharacter 
// StringLiteral StringCharacters StringCharacter EscapeSequence OctalEscape 
// UnicodeEscape ZeroToThree Identifier LPAREN RPAREN LBRACE RBRACE RBRACK 
// SEMI COMMA ASSIGN CMP_GT CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE 
// CMP_GE NOTEQUAL AND OR ADD SUB MUL DIV BITAND BITOR CARET MOD SHIFT_LEFT 
// SHIFT_RIGHT_S SHIFT_RIGHT_U WS COMMENT LINE_COMMENT 
...
// NULL_TREE_LOOKAHEAD STATEMENT BINARY_EXPRESSION INSTANCEOF_BINARY_EXPRESSION 
// UNARY_EXPRESSION PARENTHESES_EXPRESSION TYPE_CAST PRIMARY_SELECTOR DOT_SELECTOR 
// EXPRESSION_LIST "null" "true" "false" "instanceof" DOT HEX_NUMERIC_LITERAL 
// OCT_NUMERIC_LITERAL FP_NUMERIC_LITERAL DEC_NUMERIC_LITERAL HexDigit 
// DecDigit OctDigit NumericLiteral CharacterLiteral SingleCharacter StringLiteral 
// StringCharacters StringCharacter EscapeSequence OctalEscape UnicodeEscape 
// ZeroToThree Identifier LPAREN RPAREN LBRACE RBRACE LBRACK RBRACK SEMI 
// COMMA ASSIGN CMP_GT CMP_LT BANG TILDE QUESTION COLON EQUAL CMP_LE CMP_GE 
// NOTEQUAL AND OR ADD SUB MUL DIV BITAND BITOR CARET MOD SHIFT_LEFT SHIFT_RIGHT_S 
// SHIFT_RIGHT_U WS COMMENT LINE_COMMENT 
